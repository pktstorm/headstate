...
describe("App — priorities strip scoping", () => {
  ...
  it("scopes the strip to the selected repo in the list view", () => {
    ...
    useFilters.setState({ filtersByView: { "my-prs": { repo: "octocat/hello-world" }, "to-review": {}, worktrees: {}, docker: {}, artifacts: {}, packages: {}, "claude-md": {} }, view: "my-prs", panel: "list" } as never);
    renderApp();
  ...
  it("shows no priorities strip on the stats view", () => {
    ...
    useFilters.setState({ filtersByView: { "my-prs": {}, "to-review": {}, worktrees: {}, docker: {}, artifacts: {}, packages: {}, "claude-md": {} }, view: "my-prs", panel: "stats" } as never);
    renderApp();
